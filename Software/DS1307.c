...
/************************************************************************/
/*					SETEO DEL RELOJ DS1307.								*/
/*......................................................................*/
void DS1307_Setup(void)
{
	I2C_Start();			// Inicio comunicación I2C.
	I2C_Write_M(0b11010000);	// Selecciono dispositivo.
	I2C_Write_M(0x07);		// Dirección del registro CONTROL.
	I2C_Write_M(0b00);		// Configuro el registro.
	I2C_Stop();				// Termino con la comunicación I2C.
	return;
}
/************************************************************************/
/*					CONFIGURO LA HORA EN EL RTC.						*/
/*......................................................................*/
void Seteo_Hora(const char *hora)
{
	...
	min=(aux<<4)|((*hora++)-48);
	I2C_Start();				// Inicio comunicación I2C.
	I2C_Write_M(0b11010000);	// Direccion del DS1307, modo write.
	I2C_Write_M(0x00);			// Direccion de los segundos.
	I2C_Write_M(0);				// Segundos.
	I2C_Write_M(min);			// Minutos.
	I2C_Write_M(hor);			// Horas.
	I2C_Write_M(0);				//
	I2C_Write_M(dia);			// Fecha.
	I2C_Write_M(mes);			// Mes.
	I2C_Write_M(ano);			// Año.
	I2C_Stop();					// Termino con la comunicación I2C.
	return;
...
void Obtener_Hora(unsigned char *hora, unsigned char formato)
{
	...
	unsigned char aux;
	I2C_Start();
	I2C_Write_M(0b11010000);	// Selecciono el dispositivo.
	I2C_Write_M(0x0);
	I2C_Stop();
	I2C_Start();
	I2C_Write_M(0b11010001);	// Selecciono el dispositivo.
